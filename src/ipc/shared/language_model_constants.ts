...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  "gemini-cli": [
    ...
    },
    {
      ...
      description: "Gemini Flash via Gemini CLI (Free)",
      maxOutputTokens: 65_536,
      contextWindow: 1_048_576,
      temperature: 0,
      dollarSigns: 0,
  ...
  "qwen-code-cli": [
    {
      name: "qwen-2.5-coder",
      displayName: "Qwen 2.5 Coder (CLI)",
      description: "Qwen 2.5 Coder via Qwen Code CLI (Free)",
      maxOutputTokens: 32_000,
      contextWindow: 128_000,
      temperature: 0,
      dollarSigns: 0,
    },
    {
      ...
      displayName: "Qwen 2.5 Coder Turbo (CLI)",
      description: "Qwen 2.5 Coder Turbo via Qwen Code CLI (Free)",
      maxOutputTokens: 32_000,
      contextWindow: 128_000,
      temperature: 0,
      dollarSigns: 0,
...
> = {
  ...
  chatmock: {
    displayName: "ChatMock (Codex)",
    hasFreeTier: true,
    websiteUrl: "https://github.com/RayBytes/ChatMock",
    gatewayPrefix: "",
    secondary: true,
  },
};
